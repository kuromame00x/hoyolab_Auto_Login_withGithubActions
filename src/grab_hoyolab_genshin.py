...
from grab_urls import HOYOLAB_GI_URL


def main() -> int:
    ap = argparse.ArgumentParser(description="Open Genshin HoYoLAB sign-in page and read cookie values from default browser profile.")
