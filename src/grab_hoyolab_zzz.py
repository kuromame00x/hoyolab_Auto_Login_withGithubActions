...
from grab_urls import HOYOLAB_ZZZ_URL


def main() -> int:
    ap = argparse.ArgumentParser(description="Open ZZZ HoYoLAB sign-in page and read cookie values from default browser profile.")
