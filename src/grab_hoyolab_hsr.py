...
from grab_urls import HOYOLAB_HSR_URL


def main() -> int:
    ap = argparse.ArgumentParser(description="Open HSR HoYoLAB sign-in page and read cookie values from default browser profile.")
